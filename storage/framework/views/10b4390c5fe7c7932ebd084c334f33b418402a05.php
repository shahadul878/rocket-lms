            ...
            <form action="/admin/settings/main" method="post">
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="contentTranslate"><?php echo e(trans('admin/main.content_translate')); ?></label>
                    </label>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/codereye/domains/codereyes.com/public_html/lms/resources/views/admin/settings/general/basic.blade.php ENDPATH**/ ?>